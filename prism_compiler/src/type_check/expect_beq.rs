...
//     pub fn expect_beq_type(&mut self, io: CoreIndex, s: &PrismEnv) {
//         let (i, s) = self.db.beta_reduce_head(io, s);
//         match self.db.exprs[*i] {
//             Expr::Type => {}
//             Expr::Free => {
//                 self.db.exprs[*i] = Expr::Type;
...
//     /// `rt` should be free.
//     pub fn expect_beq_fn_type(&mut self, ft: CoreIndex, at: CoreIndex, rt: CoreIndex, s: &PrismEnv) {
