...
// use crate::type_check::{CheckerSessionState, UniqueVariableId};
// use std::collections::HashMap;
//
// const MAX_BEQ_DEPTH: usize = 256;
//
// impl<'a> CheckerSessionState<'a> {
//     #[must_use]
...
//         (i1o, s1, var_map1): (CoreIndex, &PrismEnv, &mut HashMap<UniqueVariableId, usize>),
//         (i2o, s2, var_map2): (CoreIndex, &PrismEnv, &mut HashMap<UniqueVariableId, usize>),
//         depth: usize,
//     ) -> bool {
...
//         &mut self,
//         (i1, s1, var_map1): (CoreIndex, &PrismEnv, &mut HashMap<UniqueVariableId, usize>),
//         (i2, s2, var_map2): (CoreIndex, &PrismEnv, &mut HashMap<UniqueVariableId, usize>),
//         depth: usize,
//     ) -> bool {
...
//
//     #[must_use]
//     pub fn handle_constraints(&mut self, i2: CoreIndex, s2: &PrismEnv, depth: usize) -> bool {
//         let mut eq = true;
//
