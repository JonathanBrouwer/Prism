...
use prism_parser::parsable::{ParseResult, SimpleParsable};

impl<'arn, 'grm: 'arn> ParseResult<'arn, 'grm> for UnionIndex {}
impl<'arn, 'grm: 'arn> SimpleParsable<'arn, 'grm, TcEnv<'grm>> for UnionIndex {
    fn from_construct(
        span: Span,
        constructor: &'grm str,
        args: &[Parsed<'arn, 'grm>],
...
impl<'arn, 'grm: 'arn> SimpleParsable<'arn, 'grm, TcEnv<'grm>> for ScopeEnter<'arn, 'grm> {
    fn from_construct(
        span: Span,
        constructor: &'grm str,
        args: &[Parsed<'arn, 'grm>],
