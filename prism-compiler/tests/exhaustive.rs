// use bumpalo::Bump;
// use prism_compiler::lang::{PrismEnv, CheckedPrismExpr, CheckedIndex};
// use prism_parser::core::cache::Allocs;
//
// #[test]
// fn test_exhaustive() {
//     iter_exhaustive(5, false, |env, root| env.to_checkable(root).is_ok())
// }
//
// fn iter_exhaustive(
//     max_depth: usize,
...
//                 }
//             }
//             CheckedPrismExpr::Let(_, e1, e2) => CheckedPrismExpr::FnType("", e1, e2),
//             CheckedPrismExpr::FnType(_, e1, _) => {
//                 env.checked_values.pop().unwrap();
//                 env_size.pop().unwrap();
//                 env_size[*e1] += 1;
//                 CheckedPrismExpr::FnConstruct("", e1)
//             }
//             CheckedPrismExpr::FnConstruct(_, e1) => {
//                 env_size[*e1] -= 1;
//                 env_size.push(env_size[*i]);
...
//             CheckedPrismExpr::Name(_) => unreachable!(),
//             CheckedPrismExpr::ShiftLabel(_, _) => unreachable!(),
//             CheckedPrismExpr::ShiftTo(_, _, _) => unreachable!(),
//             CheckedPrismExpr::ParserValue(_) => unreachable!(),
//             CheckedPrismExpr::ParserValueType => unreachable!(),
//         };
//         return true;
//     }
// }
