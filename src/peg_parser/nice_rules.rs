...
mod tests {
    ...
    fn test_left_recursive1() {
        ...
        rules.insert("R1", NicePegRule::ChooseFirst(vec![NicePegRule::LiteralExact(T::A), NicePegRule::LiteralBind(TT::A)]));
        rules.insert("R2", NicePegRule::Sequence(vec![NicePegRule::Rule("R2"), NicePegRule::Rule("R1")]));
        let (res, res_start) = nice_rules_to_peg(rules, "R2");
